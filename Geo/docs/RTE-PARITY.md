...
| B8 | Fenced code block + syntax highlight | ⚠️ | [MarkdownBlockParser.swift:97](../Shared/DesignSystem/Editor/MarkdownBlockParser.swift); [SyntaxHighlighter.swift](../Shared/DesignSystem/Markdown/SyntaxHighlighter.swift) | Only HTML, CSS, JSON, Markdown, SQL highlighted. Obsidian uses Prism (~200 langs). Generic fallback for unknown langs. |
...
| I2 | Italic `*x*` / `_x_` | ⚠️ | [AutoFormatEngine.swift:36](../Shared/DesignSystem/Editor/AutoFormatEngine.swift) `findSingleStarPattern` | Only `*…*` recognised by auto-format; `_…_` parser path unverified. |
...
| I9 | Bare URL autolink | ⚠️ | Verify InlineParser handles raw `https://…` without `[]()` wrapping. | If absent, document and add. |
...
| I16 | Inline image (paste) | ⚠️ | [AttachmentHandler.swift](../Features/Blocks/UI/AttachmentHandler.swift); [InlineImageLoader.swift](../Shared/DesignSystem/Markdown/InlineImageLoader.swift) | Paste works. Drag-drop file → insert image not wired. |
