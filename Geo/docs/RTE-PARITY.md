...
| U5 | Inline auto-format (`**x**` → bold) | ✅ | [AutoFormatEngine.swift](../Shared/DesignSystem/Editor/AutoFormatEngine.swift) | Pairs: `**`, `*`, `_`, `~~`, `==`, `` ` ``; bare `http(s)://…` autolinks on type. |
