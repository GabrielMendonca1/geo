...
grep -q 'NSVisualEffectView' "$ROOT/Sources/HubPanel.swift"
check $? "the card is real glass, not a painted rectangle"
grep -q 'material = .popover' "$ROOT/Sources/HubPanel.swift"
check $? "it uses the same material as native menu bar popovers"
